...
(select	rl.EvalMonth ,Count(rl.EvalMonth) as Cell_Data
	...
	where MoveOut_Category = 'Higher LOC' and si.carelevelcode in ('AL','PC')
 	Group by
	rl.EvalMonth
) r
...
update #Clinical_KPI_Results set Report_Index = 'S2010' where Description = 'Total Discharges - Deaths < 90 Days'
